...
def loadData():
    df = pd.read_csv("gutenberg_texts_2.csv", nrows=1000)
...
def train_model():
    ...
    tuner.search(trainInput, trainTarget, epochs=100, batch_size=128)
    ...
    # Visualize training
    history = best_model.history.history  # Access training history
